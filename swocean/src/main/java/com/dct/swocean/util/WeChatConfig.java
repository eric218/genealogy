 ...
 * @Description: 微信支付的一些参数配�? * Copyright: Copyright (c) 2016
 *               Company:FURUIBOKE.SCIENCE.AND.TECHNOLOGY
 * 
 * @author leechenxiang
 * @date 2017�?�?1�?下午2:54:50
 * @version V1.0
 */
public class WeChatConfig {

	public static final String APPID = "xxxxxxxxxxxxxxxx"; // 公众账号ID
	public static final String MCH_ID = "yyyyyyyyyyyyyyy"; // 商户�?
	...
	// 接收微信支付异步通知回调地址，�?知url必须为直接可访问的url，不能携带参数�?（需要配置）
