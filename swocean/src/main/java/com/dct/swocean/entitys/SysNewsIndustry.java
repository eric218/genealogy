...
public class SysNewsIndustry {
    ...
    public void setNewsColumn(String newsColumn) {
        this.newsColumn = newsColumn == null ? null : newsColumn.trim();
    }
    ...
    public void setIndustryLocation(String industryLocation) {
        this.industryLocation = industryLocation == null ? null : industryLocation.trim();
    }
