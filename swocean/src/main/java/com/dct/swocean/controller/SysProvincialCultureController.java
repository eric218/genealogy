...
public class SysProvincialCultureController {
	...
	// 文章ID writingsId
	public Response<SysConstantInfo> provincialUnderling(
			@RequestParam("areaCode") String areaCode, //省级ID
			@RequestParam("familyName") String familyName, //姓氏
			HttpServletResponse res) {
			// 跨域解决
			res.setHeader("Access-Control-Allow-Origin", "*");
			Response<SysConstantInfo> provincialUnderling = sysFamilyCultureService.provincialUnderling(areaCode,familyName);
