<div
	style="border: 1px solid #aaa; position: absolute; left: 50%; top: 50%; width: 350px; height: 390px; margin-left: -175px; margin-top: -195px;">
	<div style="padding: 5px; border-bottom: 1px solid #aaa;">
		订单号：${ oid }<br /> 总金额：<font color="red">${totalprice}元</font>
	</div>
...
<script type="text/javascript">
	...
	(function polling() {
		$.ajax({
			url : "/pay/wx/checkStatus?oid=${oid}&payAmount=${totalprice}",
			cache : false, // 禁用缓存
